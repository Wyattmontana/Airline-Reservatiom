...
b1 := ((sumx2squared * sumx1y) - (sumx1x2 * sumx2y))/((sumx1squared * sumx2squared) - (sumx1x2 * sumx1x2));
--dbms_output.put_line(b1);

b2 := ((sumx1squared * sumx2y) - (sumx1x2 * sumx1y))/((sumx1squared * sumx2squared) - (sumx1x2 * sumx1x2));
